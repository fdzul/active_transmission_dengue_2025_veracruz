...
Curso presencial de miercoles a jueves.


## Sede

Aula de la Dirección de Vigilancia Epidemiológica de Enfermedades
Emergentes y Reemergentes, 5to Piso del Centro de Gobierno de León, ubicado en Blvd. Delta #201,
Fracciones de Santa Julia, C.P. 37290, en el municipio de León. Gto.

```{r, echo=FALSE}
tibble::tibble(lat = 21.095610,
               long = -101.616864) |>
...
Se realizá un examen previo y posterior al curso. El examen previo se realizá una semana antes del curso y el examen posterior se realizará durante el curso.
