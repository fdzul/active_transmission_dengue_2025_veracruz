...
Curso presencial de Lunes y martes.

## Sede

Aula de la especialidad de Métodos Estadísticos, segundo Piso de la Facultad de Estadística e Informaticas, Avenida xalapa, Colonia Obrero Campesina, 91020 Xalapa de Enríquez, Veracruz.


```{r, echo=FALSE}
tibble::tibble(lat = 19.541583,
               long = -96.927169) |>
